...
Next, we will read and clean precipitation data for 2018 and 2019. it rows without precipitation data and add a variable for year. Next, combine precipitation data sets and convert month to a character variable (the variable month.name is built into R and should be useful).
...
#### Scatter plot 
Produce a scatter plot showing the number of children with a name (y axis) against the rank in popularity of that name (x axis), for male, white, non hispanic children born
in 2016.
